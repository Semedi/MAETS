...
?>
	...
	<body>
		...
		<button name="eliminarUsuario" id="eliminarUsuario" onclick="location.href ='../community/eliminarUsuario.php';">Eliminar usuario</button>
		<?php generarListaUsuarios(); ?>

		<h1> Logros </h1>
		<button name="anadirLogros" id="anadirLogros" onclick="location.href ='';">Añadir nuevo logro</button>
		<button name="eliminarLogro" id="eliminarLogro" onclick="location.href ='../community/eliminarLogro.php';">Eliminar logro</button>
		...
		<button name="eliminarCaptura" id="eliminarCaptura" onclick="location.href ='../community/eliminarCaptura.php';">Eliminar captura</button>
		...
		<button name="eliminarVideo" id="eliminarVideo" onclick="location.href ='../community/eliminarVideo.php';">Eliminar video</button>
		...
		<button name="eliminarAnalisis" id="eliminarAnalisis" onclick="location.href ='../community/eliminarAnalisis.php';">Eliminar analisis</button>
